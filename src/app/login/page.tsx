  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-gray-100 flex flex-col justify-center py-8 sm:py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="animate-float absolute top-20 left-10 w-20 h-20 bg-gray-300 rounded-full blur-xl"></div>
        <div className="animate-float-delayed absolute top-40 right-20 w-32 h-32 bg-gray-400 rounded-full blur-xl"></div>
        <div className="animate-pulse absolute bottom-32 left-1/4 w-16 h-16 bg-gray-300 rounded-full blur-lg"></div>
      </div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-3 text-center text-sm text-gray-600 animate-fade-in-up animation-delay-400">
          Access your premium digital collection{' '}
          <Link href="/register" className="font-medium text-black hover:text-gray-700 transition-colors duration-300 hover:underline">
